...
if ( ! defined( 'WP_FAIL2BAN_REDUX_TESTS_DIR' ) ) {
	define( 'WP_FAIL2BAN_REDUX_TESTS_DIR', dirname( dirname( __FILE__ ) ) );
}
 ...
 */
if ( false !== getenv( 'WP_PHPUNIT__DIR' ) && defined( 'WP_FAIL2BAN_REDUX_USE_WP_ENV_TESTS' ) ) {
